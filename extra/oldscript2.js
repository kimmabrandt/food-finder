...
[
 ...
 {
   "restaurant": "Around the Corner Café",
   "area": "Mt Rainier",
   "city": "Orting",
 ...
 },
 {
   ...
   "comments": "One of the best burgers I have ever had.  It's a total dive in the best possible way.  Mushroom Swiss and and Irish Death cures all ills…\nHave to agree! Wandered in one night because it was the only thing open... now we go back whenever we can 👍🏼"
 },
 {
 ...
 },
 {
   ...
   "comments": "After Carbonado area hikes.  Margaritas after hiking….MMMMMMMM"
 },
 {
   "restaurant": "Maharaja",
   "area": "Mt Rainier",
 ...
 },
 {
   ...
   "comments": "Pre-hike.  You will love the gluten free baked goods.  If you are gluten free it’s the place to go and even if you are not glute free well you will like it too.  The hand pies are to die for…my favorite!  The have a great breakfast and lunch menu as well"
 },
 {
 ...
 },
 {
   ...
   "comments": "Surprisingly awesome.  \nNegative comment:  The worst food I have ever had was at the Marblemount Diner…fish and chips were so bad and overcooked that I couldn't eat them…even the mildhske was warm…sorr Marblemount, you are a cute lil town but that diner is awful...hopefully I haven't hurt anyone's feelings.  When we are in that area again i will try Mondo's...I think the only reason we went to the diner was they had milkshakes. \n Negative comment:  My husband said the same thing, it's like night and day from Mondo's."
 },
 {
 ...
 },
 {
   ...
   "comments": "On your way down from Mt Baker Wilderness.  Locally owned brewery and they make the best pizza and beer.  More rustic pizza place alternative that’s amazing in everyway!\nAfter hiking Mt. Baker\nGood pizza and great beer!"
 },
 {
 ...
 },
 {
   ...
   "comments": "If you hike up north and head south home, it’s a must"
 },
 {
 ...
 {
   "restaurant": "Ironworks Café & Market",
   "area": "SE Washington",
   "city": "Othello",
...
// );
  ...
  var createMarker = function(info) {
    ...
    marker.content = '<div class="infoWindowContent">' + info.comments + '</div>';
...
for (i = 165; i < 171; i++){
     ...
     function(results, status) {
       if (status == google.maps.GeocoderStatus.OK) {
             ...
             console.dir(JSON.stringify(latitudes, null, 2));
             console.dir(JSON.stringify(longitudes, null, 2));
         //  } else {
         //     latitudes.push('not working');
         //     longitudes.push('not working');
         //     console.dir(JSON.stringify(latitudes, null, 2));
         //     console.dir(JSON.stringify(longitudes, null, 2));
         //  }
      }
     })
console.log(places2geocode[165].address)
}
 // if (status == 'OK') {
